defmodule AuctionAppWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: AuctionAppWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/auction_app_web/templates",
        namespace: AuctionAppWeb
      ...
      import AuctionAppWeb.ErrorHelpers
      import AuctionAppWeb.Gettext
      alias AuctionAppWeb.Router.Helpers, as: Routes
    end
  end
